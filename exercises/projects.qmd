...
4.  Name the directory "YourName_CSEE-Workshop-2023" and navigate to the subdirectory in your computer where you want the folder to appear
...
6.  Open the folder (you should see one file in there, an .Rproj file with the name you gave the folder)
    -   Create five folders within your project folder:
        ...
        -   R
7.  Download the data from this [link](https://portal.edirepository.org/nis/dataviewer?packageid=knb-lter-pal.34.7&entityid=0fccb4e99aaa0c0cc85c23284288ec81) and move it into the `input/` folder
...
11. *(If you have time)* Share this directory with a neighbour and see if you can each open and work with each other's project
