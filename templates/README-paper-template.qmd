# [Paper Template](https://github.com/wildlifeevoeco/MovingAcrossGradients) (downloaded from Webber et al.'s^1^ GitHub page on June 6 2023):

------------------------------------------------------------------------

## The ecology of individual differences empirically applied to space-use and movement tactics

[![](https://zenodo.org/badge/226946276.svg)](https://zenodo.org/badge/latestdoi/226946276)
